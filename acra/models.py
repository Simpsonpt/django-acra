...
class CrashReport(models.Model):
	...
	total_mem_size = models.IntegerField(default=0,verbose_name='Total Memory Size')
	initial_configuration = models.TextField(default="")
	display = models.TextField(default="")
	available_mem_size = models.IntegerField(default=0,verbose_name='Available Memory Size')
